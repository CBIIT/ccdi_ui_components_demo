...
import { FilterCategory } from "@/components/blocks/filter-sidebar/filter-sidebar-types"
...
export const sampleCategories: FilterCategory[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        sortEnabled: true,
        options: [
          { id: "diagnosis-basis-clinical", label: "Clinical", count: 17136 },
      ...
      },
      {
        ...
        options: [
          ...
          { id: "disease-phase-progression", label: "Progression", count: 369 }
        ]
      }
    ]
  },
    ...
    children: [
      {
        ...
        options: [
          ...
          { id: "sex-at-birth-not-reported", label: "Not Reported", count: 396 },
          { id: "sex-at-birth-unknown", label: "Unknown", count: 36 },
        ]
      },
      {
        id: "item-race",
        ...
        options: [
          ...
          { id: "race-not-reported", label: "Not Reported", count: 4819 },
          { id: "race-unknown", label: "Unknown", count: 4115 },
    ...
    children: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "treatment-type-other", label: "Other", count: 345 },
        ]
      },
    ]
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        sortEnabled: true,
        options: [
          { id: "response-category-unknown", label: "Unknown", count: 2246 }
        ]
      },
    ]
  },
    ...
    children: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "first-event-progression", label: "Progression", count: 124 },
      ...
      },
      {
        ...
        options: [
          ...
          { id: "last-known-survival-status-not-reported", label: "Not Reported", count: 1695 },
          { id: "last-known-survival-status-unknown", label: "Unknown", count: 30902 },
    ...
    children: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "sample-anatomic-site-other", label: "Other", count: 1 }
        ]
      },
      {
        ...
        options: [
          ...
          { id: "sample-tumor-status-not-reported", label: "Not Reported", count: 234 },
    ...
    children: [
      {
        ...
        sortEnabled: true,
        options: [
          { id: "data-category-clinical", label: "Clinical", count: 7014 },
          { id: "data-category-genomics", label: "Genomics", count: 5354 },
    ...
    children: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "library-source-molecule-not-reported", label: "Not Reported", count: 5378 },
